...
class JSONRPCWalletTestCase(JSONTestCase):
    ...
    def test_seed(self, mock_post):
        ...
        phrase = (
            "phrases petals speedy fuming ascend weird duplex identity "
    ...
    def test_incoming_by_tx_id__not_found(self):
        ...
        self.wallet = Wallet(JSONRPCWallet())
        pmts = self.wallet.incoming(
            tx_id="e0b15ac819c94ed9ba81edb955a98c696f3216335960ccf90018d76a8dcb0e7e"
        )
        self.assertEqual(len(pmts), 0)
    ...
    def test_outgoing_by_tx_id(self):
        ...
        pmts = acc.outgoing(
            tx_id="362c3a4e601d5847b3882c3debfd28a0ee31654e433c38498539677199c304c2"
        )
        self.assertEqual(len(pmts), 1)
                ...
                "out": [
                    {
                        ...
                        "destinations": [
                            {
                                "address": "BaB4Xsi9fBPDutsdNWTzNN5qgmTE2WUwnMGm5ukkb9TXUJHQLyZhQikekhHX8zhmRn3VTJeniuMXJHuCHfKyPk1XQDfk9bw",
                                "amount": 70000000000,
                            }
                        ],
                        "double_spend_seen": False,
                    ...
                    },
                    {
                        ...
                        "destinations": [
                            {
                                "address": "BczAN2ZV5MENFAqSBdJJpzW9CMqURR9XTCjihzEGHzCV58YFRZHYuhk2huFsBrbPtDN2dGWHgiY1CRTUAPeDJg1ZFCzCssT",
                                "amount": 21000000000000,
                            }
                        ],
                        "double_spend_seen": False,
                    ...
                    },
                    {
                        ...
                        "destinations": [
                            {
                                "address": "BZHa2Fm9yn3by1CWTBruWxEuZ5TqyMLiBQAFrHM6aniLfjTBWkA4E4kif63YS7wmbFW5UBwrFSKNoiSQ2mE8SS5S6uzgvoc",
                                "amount": 1000000000000,
                            }
                        ],
                        "double_spend_seen": False,
                    ...
                    },
                    {
                        ...
                        "destinations": [
                            {
                                "address": "BYeK7sZ9DhkASZpMrhGw6yFynaDy5PJ8T2CeogvGTFfT2kMQdTNJFQpDXpoHNBPTyNfrxERdRje9bBJh7LTqN4oDUVVvzAe",
                                "amount": 123000000000,
                            }
                        ],
                        "double_spend_seen": False,
    ...
    def test_send_transfer(self, mock_post):
        ...
        mock_post.return_value.json.return_value = {
            ...
            "result": {
                ...
                "multisig_txset": "",
                "tx_blob_list": [
                    ""
                ],
                "tx_hash_list": [
    ...
    def test_export_import_outputs(self, mock_post):
        ...
        mock_post.return_value.json.return_value = {
            ...
            "jsonrpc": "2.0",
            "result": {
                "outputs_data_hex": ""
            },
        }
    ...
    def test_incoming_from_self__issue_71(self):
        ...
        responses.add(
            ...
            self.jsonrpc_url,
            json=self._read(
                "test_incoming_from_self__issue_71-1a75f-get_transfer_by_txid.json"
            ),
            status=200,
        )
        self.wallet = Wallet(JSONRPCWallet())
        pmts = self.wallet.incoming(
            tx_id="1a75f3aa57f7912313e90ab1188b7a102dbb619a324c3db51bb856a2f40503f1"
        )
        self.assertEqual(len(pmts), 1)
